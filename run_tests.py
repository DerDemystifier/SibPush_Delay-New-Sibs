...
from testing.scenarios.test_bury_next_sibling_for_addon_owned_four_card_notes import (
...
from testing.scenarios.test_manual_unsuspend_reprocesses_addon_owned_new_card import (
...
from testing.scenarios.test_clear_ownership_marker_when_last_sibling_is_restored import (
...
from testing.scenarios.test_reveal_next_sibling_for_addon_owned_four_card_notes import (
    test_process_all_notes_reveals_the_next_sibling_for_addon_owned_four_card_notes,
)
from testing.scenarios.test_clear_ownership_marker_for_user_unsuspended_trailing_card import (
...
tests = {
    ...
    "test_process_all_notes_clears_the_ownership_marker_after_restoring_the_last_sibling": test_process_all_notes_clears_the_ownership_marker_after_restoring_the_last_sibling,
    "test_reviewer_hook_clears_the_ownership_marker_after_burying_the_last_sibling": test_reviewer_hook_clears_the_ownership_marker_after_burying_the_last_sibling,
    ...
    "test_process_all_notes_reveals_the_next_sibling_for_addon_owned_four_card_notes": test_process_all_notes_reveals_the_next_sibling_for_addon_owned_four_card_notes,
    "test_manual_unsuspend_of_addon_owned_new_card_is_reprocessed_and_suspended_again": test_manual_unsuspend_of_addon_owned_new_card_is_reprocessed_and_suspended_again,
    "test_process_all_notes_clears_the_ownership_marker_for_a_user_unsuspended_trailing_card": test_process_all_notes_clears_the_ownership_marker_for_a_user_unsuspended_trailing_card,
    "test_reviewer_hook_buries_the_next_sibling_for_addon_owned_four_card_notes": test_reviewer_hook_buries_the_next_sibling_for_addon_owned_four_card_notes,
